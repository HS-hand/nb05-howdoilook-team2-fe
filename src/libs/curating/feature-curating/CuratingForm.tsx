...
import enhancedFetch from '@services/fetch'
...
const CuratingForm = ({ styleId, defaultValues, onSubmit }: CuratingFormProps) => {
  //console.log('CuratingForm 렌더링, styleId:', styleId)
