...
import CuratingForm from '@libs/curating/feature-curating/CuratingForm'
import CuratingCreateButton from '@libs/curating/feature-curating/CuratingCreateButton'
...
const StyleDetailPage = ({ params, searchParams }: StyleDetailPageProps) => {
  ...
  //console.log('StyleDetailPage styleId:', styleId)
  const {
